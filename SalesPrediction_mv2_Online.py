...
def train_test():
    ...
    with tf.Session(graph=config.graph) as sess:
        ...
        plot(nonescaled_y, pred_vals, "Sales Prediction VS Truth mv_Online2.png")
        write_results(nonescaled_y, pred_vals, "Sales Prediction batch mv_Online2 results.csv")
