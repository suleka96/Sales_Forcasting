...
def Linear_Regression():
    ...
    plot(nonescaled_y,pred_vals,"Liner Regression lagged mv Prediction Vs Truth.png")
...
def XGB():
    ...
    plot(nonescaled_y, pred_vals, "XGBoost Regressor lagged mv Prediction Vs Truth.png")
...
def Random_Forest_Regressor():
    ...
    plot(nonescaled_y,pred_vals,"Random Forest Regressor lagged mv Prediction Vs Truth.png")
